---
title: "too many tokens: total number of tokens in the prompt cannot exceed 4081 - received 4588. Try using a shorter prompt, or enabling prompt truncating. See [REDACTED_URL] for more details."
provider: "cohere"
