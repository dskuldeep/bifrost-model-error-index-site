...
While less common for schema errors, requests can be blocked if the function definitions or descriptions trigger Azure OpenAI’s content management policies or safety filters.
