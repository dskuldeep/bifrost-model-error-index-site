...
4. **Inspect Axios configuration**: Confirm that the `Authorization` header is set as `Bearer YOUR_API_KEY` and that the `baseURL` points to the official OpenAI endpoint (`[REDACTED_URL]).
