...
4. **Rate Limiting**: Exceeding OpenAI’s predefined rate limits can cause the server to reject requests.
...
- [https://help.openai.com/en/articles/4936856-rate-limits](https://help.openai.com/en/articles/4936856-rate-limits)
